...
def is_perfect_square( number ) :
    ...
    if( number == int( sqrt( number ) ) * int( sqrt( number ) ) ) :
        return True
...
matriz_entrada = np.array(
    [
        [ 758, 1379, 5033, 1044, 6453, 1355,  835, 3974,  267],
...
#print( len( matriz_entrada ) )      # Columnas
#print( len( matriz_entrada[0] ) )   # Filas
